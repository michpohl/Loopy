...
//    private var holders = mutableListOf<PlayerItem>()
//
...
//        val item = PlayerItem(parent.context, binding)
//        holders.add(item)
//        return item
//    }
//
...
//        )
//
//        //TODO this can be live data in PlayerItemViewModel
...
//    }
//
//    fun highlightPlayingFile(name: String) {
//        val holder = holders.find { it.viewModel.audioModel.name == name }
//        holder?.viewModel.
//    }
//
...
//    }
//
//    private fun removeItemFromLoopsList(itemPosition: Int) {
