...
Java_com_michaelpohl_player_jni_JniBridge_startPlaybackNative(JNIEnv *env, jobject instance) {
    if (audioEngineExists(env, instance)) {
...
JNIEXPORT jboolean JNICALL
Java_com_michaelpohl_player_jni_JniBridge_pausePlaybackNative(JNIEnv *env, jobject instance) {
    if (audioEngineExists(env, instance)) {
...
JNIEXPORT jboolean JNICALL
Java_com_michaelpohl_player_jni_JniBridge_resumePlaybackNative(JNIEnv *env, jobject instance) {
    if (audioEngineExists(env, instance)) {
